...
Query: {
hello: (_, { message }) => {
return `¡Hola, ${message}! Un saludo por parte del
profe `;
},
},
};
...
// Sirve la aplicación de React desde la carpeta
"saludofront-app"
const reactAppPath = path.join(__dirname,
'saludofront-app', 'dist');
...
const PORT = 4000;
app.listen(PORT, () => {
console.log(`Servidor GraphQL ejecutándose en
